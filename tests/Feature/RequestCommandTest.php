...
it('creates the request correctly', function (): void {
    $this->artisan('somake:request')
        ...
        ->expectsQuestion('Do you want to fill the request with fields from a DTO/Data ?', false)
...
it('prefills the request with dto fields', function (): void {
    $this->artisan('somake:request')
        ...
        ->expectsQuestion('Do you want to fill the request with fields from a DTO/Data ?', true)
